"use strict"; // Paul Slaymaker, paul25882@gmail.com, https://codepen.io/aymak/pen/gOGdvGJ
...
var Brush=function(idx) {
  ...
  this.col=idx;
  //this.duration=240;
  //this.time=-Math.round(duration*Math.random());
...
var draw=()=>{
  brushes.forEach((b)=>{ 
    ...
    //ctx.fillStyle=colors[b.col%colors.length];

"use strict"; // Paul Slaymaker, paul25882@gmail.com, https://codepen.io/aymak/pen/abEbPQy
...
//ctx.setLineDash([30,30,30,30000]);
...
var getRCount=()=>{
  let bd={ "C3S1":25, "C4S1":23, "C5S2":15, "C6S1":21, "C8S1":17, "C8S3":11, "C12S1":12, "C12S5":7, "C16S1":10, "C16S3":7, "C16S5":5, "C16S7":4, "C20S1":6, "C20S3":6, "C20S7":4, "C20S9":3, "C24S1":5, "C24S5":4, "C24S7":3, "C24S11":1, "C28S1":4, "C28S3":3, "C28S5":2, "C28S9":2, "C28S11":1, "C28S13":1, "C32S1":4, "C32S3":3, "C32S5":2, "C32S7":2, "C32S9":1, "C32S11":1, "C32S13":1, "C32S15":1 };

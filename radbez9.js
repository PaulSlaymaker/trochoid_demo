...
//    if (Radii.a1<0) Radii.a1=Radii.a1+TP;
...
const COUNT=32;
//ctx.rotate(TP*3/32);	// C16 by 8 rotations	c-x-c-x
...
var draw=()=>{
  ...
  for (let i=0; i<tb.length; i++) {
    ...
    //ctx.bezierCurveTo(0,0,0,0,tb[i].x1,tb[i].y1);
    ctx.bezierCurveTo(tb[i2].x2,tb[i2].y2,tb[i].x2,tb[i].y2,tb[i].x1,tb[i].y1);
//ctx.fillStyle="hsl("+Math.round((tb[i2].a-tb[i].a)*360)+",100%,50%)";
    //ctx.fillStyle="hsl("+Math.round(ad*360)+",100%,50%)";	// 32 angle
    //ctx.fillStyle="hsl("+Math.round(ad*500)+",100%,50%)";	// 48 angle
//let hu=360-ad*500;
    ...
    //ctx.bezierCurveTo(0,0,0,0,tb[i].x2,tb[i].y2);
...
ctx.beginPath();
ctx.moveTo(0,0);
ctx.lineTo((tb[i].x2+tb[i2].x2)/2,(tb[i].y2+tb[i2].y2)/2);
ctx.strokeStyle=ctx.fillStyle;
ctx.lineWidth=ad/0.2;
ctx.stroke();
*/

//drawPoint2(tb[i].x2,tb[i].y2);
